...
* **Setting**
    ...
    * **Bellman’s Equations**
        ...
        * $Q^\pi$: expectation of $Z^\pi$
            ...
            * Bellman Operator: $T^\pi Q^\pi(x,a) =\mathbb{E}[R(x,a)] + \mathbb{E} _{P, \pi}[Q^\pi(x', a')]$
